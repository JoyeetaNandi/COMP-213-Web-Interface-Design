...
function remove() {
    favoriteDiv.removeChild(document.getElementById(favId));
    favoriteDiv.removeChild(document.getElementById("removeBtn"));
    favourites--;
}
...
function removeRoutine() {
    if (favId == this.id) {
        ...
        removeBtn.innerHTML = "Remove this > ";
        favoriteDiv.insertBefore(removeBtn, document.getElementById(favId));
